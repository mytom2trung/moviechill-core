...
namespace MovieChill\Core\Console;

use Backpack\Settings\app\Models\Setting;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\Artisan;
use MovieChill\Core\Database\Seeders\CatalogsTableSeeder;
use MovieChill\Core\Database\Seeders\CategoriesTableSeeder;
use MovieChill\Core\Database\Seeders\MenusTableSeeder;
use MovieChill\Core\Database\Seeders\PermissionsSeeder;
...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'MovieChill:install';
     ...
     * @var string
     */
    protected $description = 'Install MovieChill';
    ...
    public function handle()
    {
        ...
        $this->newLine(1);
        $this->info('MovieChill installation finished.');
