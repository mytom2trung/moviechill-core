...
namespace MovieChill\Core\Controllers\Admin;

use MovieChill\Core\Requests\MovieRequest;
 ...
 * @package MovieChill\Core\Controllers\Admin
...
class MovieCrudController extends CrudController
{
    ...
    use \MovieChill\Core\Traits\Operations\BulkDeleteOperation {
    ...
    {
        CRUD::setModel(\MovieChill\Core\Models\Movie::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/movie');
        CRUD::setEntityNameStrings('movie', 'movies');
        CRUD::setCreateView('MovieChill::movies.create',);
        CRUD::setUpdateView('MovieChill::movies.edit',);
    }
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::addColumn([
            ...
            'label' => 'Thông tin',
            'type' => 'view',
            'view' => 'MovieChill::movies.columns.column_movie_info',
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField([
            'name' => 'episodes',
            'type' => 'view',
            'view' => 'MovieChill::movies.inc.episode',
            'tab' => 'Danh sách tập phim'
        ],);

        CRUD::addField(['name' => 'update_handler', 'label' => 'Trình cập nhật', 'type' => 'select_from_array', 'options' => collect(config('MovieChill.updaters', []))->pluck('name', 'handler')->toArray(), 'tab' => 'Cập nhật']);
