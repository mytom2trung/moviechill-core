...
@php
    $widgets['before_content'] = [
        [
            ...
            'heading' => 'MovieChillCMS - Mã nguồn xây dựng website phim miễn phí và vĩnh viễn.',
            'content' =>
                '
                Phiên bản: <span class="text-danger text-break">' .
                config('MovieChill.version') .
                '</span><br/>
                Dữ liệu phim miễn phí: <a href="https://MovieChill.vip">KKPHIM</a><br/>
